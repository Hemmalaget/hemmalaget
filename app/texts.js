...
export default {
  ...
  offer: [
    {
      title: "Kontaktperson",
      text:
        "Vi tror på devisen ju fler kockar desto sämre soppa. Därför vill vi att du som kund ska kunna vända dig till din kontaktperson i alla frågor som rör assistansen. Det är kontaktpersonen som känner dig och dina behov bäst. Därför är det naturligt att din personliga kontaktperson är den som i största möjliga mån handhar alla ärenden kring din personliga assistans."
    },
    {
  ...
  benefits: [
    {
      ...
      text:
        "Hemmalaget Assistans är anslutna till KFO och deras kollektivavtal. Det innebär för dig som assistent att du har en rad olika försäkringar att tillgå som anställd hos oss. Förutom att du är försäkrad på arbetstid kan du t.ex. ansöka om 10 % extra sjuklönetillägg vid längre sjukskrivning eller 10 % extra i föräldratillägg inför föräldraledighet. Du har även en livförsäkring och vi betalar in till din tjänstepension."
    },
    {
      title: "Utbildning",
      text:
        "Hemmalaget Assistans erbjuder en rad olika utbildningar för dig som assistent. Hjärt och lungräddning, Introduktionskurs för vikarier, Bemötande och Rullstolskurs är bara några av de utbildningar som erbjuds. Utbildningarna planeras alltid i samråd med den du jobbar hos för att kunna skräddarsy relevant fortbildning för just din arbetsgrupp. Du är också alltid välkommen att komma med förslag och önskemål."
    },
    {
      title: "Friskvård",
      text:
  ...
  personel: {
    PA: {
      ...
      phone: "076 869 50 00",
      description:
        "Per-Arne har sedan 2001 jobbat i nära anknytning till assistans och startade 2010 Hemmalaget Assistans AB. Per-Arne jobbar främst från Alingsås och har helhetsansvaret för kunderna i Västra Götaland. Frihet för Per-Arne är att dra iväg några veckor med husbil runt vårt vackra land."
    }
  }
}
